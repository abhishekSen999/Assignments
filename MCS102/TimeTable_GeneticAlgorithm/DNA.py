...
class DNA(object):
    ...
    def __init__(self,theory_class_wise_partition,day_time_slots,professors,lab_class_wise_partition):
        ...
        """
        self.professor_collisions=0
        self.student_collisions=0
    ...
    def calculate_fitness(self):
        ...
        self.professor_collisions=collisions
        ...
        self.student_collisions=collisions
        
        
        
        
       
        self.individual_fitness=1/(self.student_collisions+self.professor_collisions+1)
    ...
    def calculate_fitness1(self):
        ...
        for i in range(len(self.theory_day_time_allotment)):
            for j in range(len(self.theory_day_time_allotment[i])):
                ...
                student_timetable[student_index][day_index][time_index]=str(student_timetable[student_index][day_index][time_index])+str(self.theory_class_wise_partition[i][j])+str(" - ")+str(course_professor_map[self.theory_class_wise_partition[i][j]])
        ...
        for i in range(len(self.lab_day_time_allotment)):
            for j in range(len(self.lab_day_time_allotment[i])):
                ...
                student_timetable[student_index][day_index][time_index1]=str(student_timetable[student_index][day_index][time_index1])+str(self.lab_class_wise_partition[i][j])+str(" (LAB) - ")+str(course_professor_map[self.lab_class_wise_partition[i][j]])
                student_timetable[student_index][day_index][time_index2]=str(student_timetable[student_index][day_index][time_index2])+str(self.lab_class_wise_partition[i][j])+str(" (LAB) - ")+str(course_professor_map[self.lab_class_wise_partition[i][j]])
